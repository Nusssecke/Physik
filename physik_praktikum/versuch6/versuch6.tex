...
\begin{document}
    ...
    \begin{enumerate}
        ...
        Messen Sie den Umfang von Mundstück bis zum obersten Punkt (Umfang a), sowie den Umfang der \glqq{}Tallie\grqq{} (Umfang b) wie in Abbildung\ref{fig:messungen}
    ...
    \end{equation} TODO: Wo kommt die Formel her?
    ...
    \end{equation}
    Die Fläche \(A\) des Mundstücks beträgt \label{eq:fläche_berechnet}\( \pi {\left( \frac{ \SI{0.0115}{m} }{2} \right)}^2 = \SI{1.03869e-4}{m^2} \).
    ...
    \subsubsection{Durchführung 3}
        ...
        % 2/3 * U^3 /(pi^3 D^2 t) where U=0.5895, D=0.0115, t=1.57 

    \subsection{Mittlere Geschwindigkeit}
    \( 22.4217 \frac{m}{s}, 24.8928 \frac{m}{s}, 21.2136 \frac{m}{s} \) \\
    Wir berechnen den Mittelwert der Ausströmgeschwindigkeiten:
    \begin{equation} \label{val:mittlere_geschw}
        \frac{ (22.4217 \frac{m}{s} + 24.8928 \frac{m}{s} + 21.2136 \frac{m}{s}) }{3} = \bar{v}_a = 22.8427 \frac{m}{s}
    \end{equation}
    % ( 22.4217+24.8928+21.2136 )/3
    TODO: SI
    ...
    \begin{equation}
        (p_i - p_a) = \frac{1}{2} \cdot 1.2041 \frac{kg}{m^3} \cdot {(22.8427 \frac{m}{s})}^2 = \SI{314.143}{\pascal}
    \end{equation}
    % 1/2 * 1.2041 * (22.8427)^2
    ...
    \section{Fehlerrechnung}
        ...
        \subsection{Fehler der Durchführungen}
            \subsubsection{Durchführung 1}
                ...
                \end{equation}
                % sqrt((4 b^2 U^4)/(D^4 π^6 t^2) + (4 a^2 U^6)/(9 D^4 π^6 t^4)) with U = 0.5475, D=0.0115, t=1.19, a=0.25, b=0.009
            \subsubsection{Durchführung 2}
                Aus den Werten für \(U\), \(t\), \( \Delta t \) und \(\Delta U \) folgt mit Formel\ref{eq:fehler}
                \begin{equation}
        ...
        \subsection{Mittlere Geschwindigkeitsfehler}
            TODO: Idee Fehler über mittelwerte der gemessenen Größen TODO: Darf man das?
            TODO: Oder die Mittelwerte der Längen und der Zeiten berechnen und dann Fehler
            ...
            \end{equation}
            % ( 4.83848 + 5.31905 + 3.45255 )/3

        \subsection{Fehler umrechnen auf Überdruck}
            Den Fehler des Überdrucks erhält man durch einsetzen der mittleren GeschwindigkeitTODO:ref plus/minus ihren Fehler\ref{val:geschw_fehler}
            ...
            \end{equation}
            % 1/2 * 1.2041 kg/m^3 * (22.8427m/s - 4.536694 m/s)^2
            ...
            \end{equation}
            Der Fehler für den Druck ist also \(\pm \SI{124.7813}{\pascal}\)
    
    \section{Versuch mit verkleinerter Öffnung}
        TODO: ? Vielleicht nicht machen aber sagen, dass man so den Versuch genauer messen kann.
    ...
    \subsection{Weltall}
        ...
        Einheitenkontrolle:
        \begin{equation}
            \frac{\si{m^3}}{\si{m^2} \cdot \sqrt{\frac{ \si{\pascal} }{ \frac{\si{kg}}{\si{m^3}} } }} = \frac{\si{m}}{ \sqrt{\frac{\frac{\si{kg}}{\si{m}\cdot\si{s^2}}}{\frac{\si{kg}}{\si{m^3}}}} } = \frac{\si{m}}{\sqrt{\frac{\si{m^2}}{\si{s^2}}}} = \si{s}
        \end{equation}
        ...
        die Fläche des Mundstücks\ref{eq:fläche_berechnet} \( A = \SI{1.03869e-4}{m^2} \), sowie die Dichte von Luft \( \rho = \SI{1.2041}{\frac{kg}{m^3}} \); TODO: Werte aus der Aufgabenstellung\cite{AnleitungPraktikum}
        \begin{equation}
            t_a^{Weltall} = \frac{ \SI{0.00310270}{m^3} }{ \SI{1.03869e-4}{m^2} \cdot \sqrt{ \frac{ 2(\SI{314.14}{\pascal} + \SI{101325}{\pascal})}{ \SI{1.2041}{\frac{kg}{m^3}} }} } = \SI{0.0727}{s} = \SI{72.7}{ms}
        \end{equation}
        % 0.00310270 / (1.03869e-4 * sqrt( 2 * (314.14 + 101325 ) / 1.2041))seconds
        ...
        Wir setzen hier für die Austrittszeit in unseren Versuchen auch den Durchschnitt an:
        \begin{equation}
        ...
        TODO: Voluemnfehler? Der hier berechnete Faktor ist, wenn man die aus der Aufgabenstellung bezogenen Werte GUtes Ergebnis weil Fehler nur in berechnetem Wert aber Atmosphären Druck überwiegt
    
    
    \section{Ergebnis}
        Endwert: \(\SI{314.14}{\pascal} \pm Fehler \) TODO: Wie viel Nachkommastellen?
        TODO: Prozentabweichung Fehler
        TODO: Überall SI benutzen!!!
        TODO: Formel für Druck in Abhängigkeit in von Umfang und Zeit
        TODO: Diagramm mit Werten und Druckfunktion von Zeit und Umfang, in zwei Grafen mit jeweils einer Variable plotten.
